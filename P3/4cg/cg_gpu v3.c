...
void cg_gpu(int vec_size, double* Avals, int* Acols, double* rhs, double* x)
{
    ...
    #pragma acc data copyin(Avals[0:ROWSIZE * vec_size], Acols[0:ROWSIZE * vec_size], r0[0:vec_size], rhs[0:vec_size]) copy(x[0:vec_size], p0[0:vec_size], Ax[0:vec_size])
    {
...
int main()
{
    ...
    #pragma acc data copyin(Avals[0:ROWSIZE * vec_size], Acols[0:ROWSIZE * vec_size], rhs[0:vec_size]) copyout(x_gpu[0:vec_size])
    {
